...
import 'package:ecommerce/chat/home.dart';
...
import 'package:ecommerce/chat/global.dart' as global;
...
class _ProductWidgetState extends StateMVC<ProductWidget>
  ...
  Future<String> createDynamicLink(id) async {
    var parameters = DynamicLinkParameters(
      uriPrefix: 'https://boblaapp.page.link',
      link: Uri.parse('https://bobla.me/Product?proId=$id'),
      androidParameters: AndroidParameters(
        packageName: "com.bobla.ecommerce",
      ),
      iosParameters: IosParameters(
        bundleId: "com.bobla.ecommerce",
...
//      shortUrl.toString();
  ...
  Widget myActionSheet(context) {
    return CupertinoActionSheet(
      actions: <Widget>[
        CupertinoActionSheetAction(
            onPressed: () async {
              print("Share this Item");
              var link = await createDynamicLink(widget.routeArgument.id);
              Share.share(link);
        ...
        CupertinoActionSheetAction(
            onPressed: () async {
              ...
              String url =
                  'mailto:report@bobla.io?subject=Report%20for%20${_con.product.name.replaceAll(' ', '%20')}&body=New%20plugin';
                    ...
                    onPressed: () async {
                      if (currentUser.value.email == "" ||
                        ...
                        var result = await FirebaseFirestore.instance
                            ...
                            .get();
                        print(
                            "document length" + result.docs.length.toString());
                        var doc = result.docs;
