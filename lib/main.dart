...
import 'package:ecommerce/src/repository/user_repository.dart';
import 'package:ecommerce/src/screens/product.dart';
...
import 'src/repository/product_repository.dart' as proRep;
...
class _MyAppState extends State<MyApp>{
  ...
  void initState () {
    ...
    getFirebaseUser();
    global.nonFirebaseUserId = currentUser.value.id;
  ...
  getFirebaseUser() async {
    ...
    var result = await FirebaseFirestore.instance
        ...
        .get();
    print("main page method");
    print(currentUser.value.email);
    var doc = result.docs;
    print("we are here in the init state and here is firebase id ${doc[0].reference.id}");
    global.currentUserId = doc[0].reference.id;
    print("here is the user id within init state"+global.currentUserId);
  }
...
//                    home: SplashScreen(proId: productId,),
//
